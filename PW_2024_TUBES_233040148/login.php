...
define('BASE_URL', 'http://localhost/pw_2024_tubes_233040135/');
session_start();
$error = '';
...
<body>
 ...
 <div class="container" style="width:100%; height:100vh;">
    ...
    <?php if( isset($error) ) : ?>
        <p style="color: aqua; font-style: italic;"><?php echo $error ?></p>
    <?php endif; ?>
    ...
    <form method="post">
        ...
        <button type="submit" name="login" style="margin-left: 30%;">Login</button>
        <a href="./admin/login_admin.php" class="Tombol">Admin</a>
    </form>
    </div>
    </div>
</body>
