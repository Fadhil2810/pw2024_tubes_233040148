...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
             echo "<script>alert('Pengguna berhasil didaftarkan!'); window.location.href='login.php';</script>";
        } else {
...
<div class="container" style="width: 100%; height: 100vh;">
    ...
    <form method="POST" action="register.php">
        ...
        <input type="email" id="email_user" name="email_user" required style="margin-left:23px;"><br><br>
        <label for="password_user">Password:</label>
        <input type="password" id="password_user" name="password_user" required><br><br>
        <button type="submit" value="Daftar" style="margin-left:63%;">Register </button>
    </form>
    </div>
</div>
</body>
